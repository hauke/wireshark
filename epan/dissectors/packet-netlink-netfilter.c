...
static int ett_nft_list_attr = -1;
...
static const value_string netlink_netfilter_table_set_elem_type_vals[] = {
	...
	{ NFTA_SET_ELEM_FLAGS, "flags" },
	{ NFTA_SET_ELEM_TIMEOUT, "timeout" },
	{ NFTA_SET_ELEM_EXPIRATION, "expiration" },
	{ NFTA_SET_ELEM_USERDATA, "userdata" },
	{ NFTA_SET_ELEM_EXPR, "expr" },
	{ NFTA_SET_ELEM_OBJREF, "objref" },
	{ NFTA_SET_ELEM_KEY_END, "key end" },
	{ NFTA_SET_ELEM_EXPRESSIONS, "expressions" },
	{ 0, NULL }
};

static header_field_info hfi_nft_set_elem_attr NETLINK_NETFILTER_HFI_INIT =
	{ "Set elem", "netlink-netfilter.nft.set_elem", FT_UINT16, BASE_DEC,
	   VALS(netlink_netfilter_table_set_elem_type_vals), NLA_TYPE_MASK, NULL, HFILL };
...
static const value_string netlink_netfilter_table_set_elem_list_type_vals[] = {
	{ NFTA_SET_ELEM_LIST_TABLE, "table" },
	{ NFTA_SET_ELEM_LIST_SET, "set" },
	{ NFTA_SET_ELEM_LIST_ELEMENTS, "elements" },
	{ NFTA_SET_ELEM_LIST_SET_ID, "set id" },
	{ 0, NULL }
};

static header_field_info hfi_nft_set_elem_list_attr NETLINK_NETFILTER_HFI_INIT =
	{ "Elements", "netlink-netfilter.nft.set_elem_list", FT_UINT16, BASE_DEC,
	   VALS(netlink_netfilter_table_set_elem_list_type_vals), NLA_TYPE_MASK, NULL, HFILL };

static int
dissect_nft_set_elem_list_attrs(tvbuff_t *tvb, void *data _U_, struct packet_netlink_data *nl_data, proto_tree *tree, int nla_type, int offset, int len)
{
	enum nft_chain_attributes type = (enum nft_chain_attributes) nla_type;
	netlink_netfilter_info_t *info = (netlink_netfilter_info_t *) data;
	...
	switch (type) {
		...
		case NFTA_SET_ELEM_LIST_ELEMENTS:
			return dissect_netlink_attributes(tvb, &hfi_nft_set_elem_attr, ett_nft_set_elem_attr, info, nl_data, tree, offset, len, dissect_nft_set_elem_attrs);
		case NFTA_SET_ELEM_LIST_SET_ID:
			break;
		default:
			break;
	}
...
static int
dissect_nft_list_attrs(tvbuff_t *tvb, void *data _U_, struct packet_netlink_data *nl_data, proto_tree *tree, int nla_type, int offset, int len)
{
	enum nft_expr_attributes type = (enum nft_expr_attributes) nla_type;
	netlink_netfilter_info_t *info = (netlink_netfilter_info_t *) data;
...
static const value_string netlink_netfilter_list_expr_type_vals[] = {
	{ NFTA_LIST_ELEM, "elem" },
	{ 0, NULL }
};

static header_field_info hfi_nft_list_attr NETLINK_NETFILTER_HFI_INIT =
	{ "Expr", "netlink-netfilter.nft.list", FT_UINT16, BASE_DEC,
	   VALS(netlink_netfilter_list_expr_type_vals), NLA_TYPE_MASK, NULL, HFILL };
...
dissect_nft_rule_attrs(tvbuff_t *tvb, void *data _U_, struct packet_netlink_data *nl_data, proto_tree *tree, int nla_type, int offset, int len)
{
	...
	switch (type) {
		...
		case NFTA_RULE_EXPRESSIONS:
			return dissect_netlink_attributes(tvb, &hfi_nft_list_attr, ett_nft_list_attr, info, nl_data, tree, offset, len, dissect_nft_list_attrs);
		case NFTA_RULE_COMPAT:
		case NFTA_RULE_POSITION:
		case NFTA_RULE_USERDATA:
		case NFTA_RULE_ID:
		case NFTA_RULE_POSITION_ID:
		case NFTA_RULE_CHAIN_ID:
			break;
		default:
			break;
	}
...
static const value_string netlink_netfilter_table_rule_type_vals[] = {
	{ NFTA_RULE_TABLE, "table" },
	{ NFTA_RULE_CHAIN, "chain" },
	{ NFTA_RULE_HANDLE, "handle" },
	{ NFTA_RULE_EXPRESSIONS, "expressions" },
	{ NFTA_RULE_COMPAT, "compat" },
	{ NFTA_RULE_POSITION, "position" },
	{ NFTA_RULE_USERDATA, "userdata" },
	{ NFTA_RULE_ID, "id" },
	{ NFTA_RULE_POSITION_ID, "position id" },
	{ NFTA_RULE_CHAIN_ID, "chain id" },
	{ 0, NULL }
};

static header_field_info hfi_nft_rule_attr NETLINK_NETFILTER_HFI_INIT =
	{ "Elements", "netlink-netfilter.nft.rule", FT_UINT16, BASE_DEC,
	   VALS(netlink_netfilter_table_rule_type_vals), NLA_TYPE_MASK, NULL, HFILL };
...
dissect_netfilter_nft(tvbuff_t *tvb, netlink_netfilter_info_t *info, struct packet_netlink_data *nl_data, proto_tree *tree, int offset)
{
	...
	switch (type) {
		...
		case NFT_MSG_DELSETELEM:
			return dissect_netlink_attributes_to_end(tvb, &hfi_nft_set_elem_list_attr, ett_nft_set_elem_list_attr, info, nl_data, tree, offset, dissect_nft_set_elem_list_attrs);
		case NFT_MSG_NEWRULE:
 		case NFT_MSG_GETRULE:
 		case NFT_MSG_DELRULE:
			return dissect_netlink_attributes_to_end(tvb, &hfi_nft_rule_attr, ett_nft_rule_attr, info, nl_data, tree, offset, dissect_nft_rule_attrs);
